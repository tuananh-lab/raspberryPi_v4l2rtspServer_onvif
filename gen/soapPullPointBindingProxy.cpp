...
int PullPointBindingProxy::send_GetMessages(const char *soap_endpoint_url, const char *soap_action, _wsnt__GetMessages *wsnt__GetMessages)
{
	...
	soap_tmp___tevpp__GetMessages.wsnt__GetMessages = wsnt__GetMessages;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevpp__GetMessages(soap, &soap_tmp___tevpp__GetMessages);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___tevpp__GetMessages(soap, &soap_tmp___tevpp__GetMessages, "-tevpp:GetMessages", "")
...
int PullPointBindingProxy::send_DestroyPullPoint(const char *soap_endpoint_url, const char *soap_action, _wsnt__DestroyPullPoint *wsnt__DestroyPullPoint)
{
	...
	soap_tmp___tevpp__DestroyPullPoint.wsnt__DestroyPullPoint = wsnt__DestroyPullPoint;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevpp__DestroyPullPoint(soap, &soap_tmp___tevpp__DestroyPullPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tevpp__DestroyPullPoint(soap, &soap_tmp___tevpp__DestroyPullPoint, "-tevpp:DestroyPullPoint", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int PullPointBindingProxy::send_Notify(const char *soap_endpoint_url, const char *soap_action, _wsnt__Notify *wsnt__Notify)
{
	...
	soap_tmp___tevpp__Notify.wsnt__Notify = wsnt__Notify;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevpp__Notify(soap, &soap_tmp___tevpp__Notify);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tevpp__Notify(soap, &soap_tmp___tevpp__Notify, "-tevpp:Notify", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int PullPointBindingProxy::recv_Notify(struct __tevpp__Notify& tmp)
{
	struct __tevpp__Notify *_param_1 = &tmp;
	soap_default___tevpp__Notify(soap, _param_1);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___tevpp__Notify(soap, _param_1, "-tevpp:Notify", NULL);
