...
int CreatePullPointBindingProxy::send_CreatePullPoint(const char *soap_endpoint_url, const char *soap_action, _wsnt__CreatePullPoint *wsnt__CreatePullPoint)
{
	...
	soap_tmp___tevcpp__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevcpp__CreatePullPoint(soap, &soap_tmp___tevcpp__CreatePullPoint);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___tevcpp__CreatePullPoint(soap, &soap_tmp___tevcpp__CreatePullPoint, "-tevcpp:CreatePullPoint", "")
