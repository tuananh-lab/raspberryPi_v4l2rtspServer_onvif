...
int PullPointSubscriptionBindingProxy::send_PullMessages(const char *soap_endpoint_url, const char *soap_action, _tev__PullMessages *tev__PullMessages)
{
	...
	soap_tmp___tevpps__PullMessages.tev__PullMessages = tev__PullMessages;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevpps__PullMessages(soap, &soap_tmp___tevpps__PullMessages);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___tevpps__PullMessages(soap, &soap_tmp___tevpps__PullMessages, "-tevpps:PullMessages", "")
...
int PullPointSubscriptionBindingProxy::send_Seek(const char *soap_endpoint_url, const char *soap_action, _tev__Seek *tev__Seek)
{
	...
	soap_tmp___tevpps__Seek.tev__Seek = tev__Seek;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevpps__Seek(soap, &soap_tmp___tevpps__Seek);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tevpps__Seek(soap, &soap_tmp___tevpps__Seek, "-tevpps:Seek", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int PullPointSubscriptionBindingProxy::send_SetSynchronizationPoint(const char *soap_endpoint_url, const char *soap_action, _tev__SetSynchronizationPoint *tev__SetSynchronizationPoint)
{
	...
	soap_tmp___tevpps__SetSynchronizationPoint.tev__SetSynchronizationPoint = tev__SetSynchronizationPoint;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevpps__SetSynchronizationPoint(soap, &soap_tmp___tevpps__SetSynchronizationPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tevpps__SetSynchronizationPoint(soap, &soap_tmp___tevpps__SetSynchronizationPoint, "-tevpps:SetSynchronizationPoint", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
