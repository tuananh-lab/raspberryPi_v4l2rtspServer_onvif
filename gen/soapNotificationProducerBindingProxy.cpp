...
int NotificationProducerBindingProxy::send_Subscribe(const char *soap_endpoint_url, const char *soap_action, _wsnt__Subscribe *wsnt__Subscribe)
{
	...
	soap_tmp___tevnp__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevnp__Subscribe(soap, &soap_tmp___tevnp__Subscribe);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___tevnp__Subscribe(soap, &soap_tmp___tevnp__Subscribe, "-tevnp:Subscribe", "")
...
int NotificationProducerBindingProxy::send_GetCurrentMessage(const char *soap_endpoint_url, const char *soap_action, _wsnt__GetCurrentMessage *wsnt__GetCurrentMessage)
{
	...
	soap_tmp___tevnp__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_begin(soap);
	soap_set_version(soap, 2); /* use SOAP1.2 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___tevnp__GetCurrentMessage(soap, &soap_tmp___tevnp__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tevnp__GetCurrentMessage(soap, &soap_tmp___tevnp__GetCurrentMessage, "-tevnp:GetCurrentMessage", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
