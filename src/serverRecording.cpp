/* --------------------------------------------------------------------------
Here implement various operations for managing recordings in an ONVIF-compliant system using the SOAP protocol. 
Operations include retrieving service capabilities, creating and deleting recordings, configuring recording settings, exporting recorded data, and querying job states.
-----------------------------------------------------------------------------
 serverRecording.cpp
