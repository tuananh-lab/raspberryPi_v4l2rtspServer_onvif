/* --------------------------------------------------------------------------
This file implements PTZ control service functions based on the ONVIF standard
The functions enable interaction with PTZ devices via the SOAP protocol for control and information retrieval tasks:capabilities,options,status,manage,control
-----------------------------------------------------------------------------
 serverPTZ.cpp
