/* --------------------------------------------------------------------------
Here implements various ONVIF search service operations, including capabilities retrieval and different types of searches 
such as recordings, events, PTZ positions, and metadata, along with state management for ongoing searches.
-----------------------------------------------------------------------------
 serverSearch.cpp
